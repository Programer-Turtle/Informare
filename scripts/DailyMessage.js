...
async function GetDailyMessage() {
    ...
    try {
        const response = await fetch('https://informarewebserver.karsonoculus.repl.co/GetDailyMessage', {
            method: 'POST',
            headers: {
...
async function PostDailyMessage() {
    ...
    try {
        ...
        const response = await fetch('https://informarewebserver.karsonoculus.repl.co/AddDailyMessage', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function CheckIfEditor() {
    ...
    try {
        const response = await fetch('https://informarewebserver.karsonoculus.repl.co/CheckForPermission', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
