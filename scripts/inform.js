let menu = ["Sunday", "Chili Cheese HotDog", "Crispy Chicken Legs", "Papa Johns", "Hamb/Cheese", "Quesadillas", "Saturday", "Sunday", "Popcorn Chicken", "Buffalo Dip", "Calzones", "Taco Salad", "Crispy Chicken", "Saturday", "Sunday", "Sloppy Joe-Bun", "Orange Chicken", "Parent Teacher Conference", "Hamb/Cheese", "French Bread", "Saturday", "Sunday", "Fall Break", "Fall Break", "Fall Break", "Fall Break", "Fall Break", "Saturday", "Sunday", "Calzones", "Witches Warts, Mummy FIngers, Eye of Newt Toes, Werewolf Teeth, and Dracula's Coffin Bat Juice"];
