async function PublishPost() {
    ...
    try {
        const response = await fetch('https://informare-api.onrender.com/PublishPost', {
            method: 'POST',
            headers: {
...
async function DeltePost(messageID) {
    ...
    try {
        const response = await fetch('https://informare-api.onrender.com/DeletePost', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function GetPostList()
{
    ...
    try {
        const response = await fetch('https://informare-api.onrender.com/GetPosts', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
